        ...
        for day_index, day_name in enumerate(ScheduleCoder.DAYS_OF_WEEK_ORDER):
            ...
            for slot_index in range(3):  # Max 3 slots per day
                ...
                if slot_index < len(slots):
                    ...
                    packed_slot = struct.pack(
                        ScheduleCoder._SLOT_FORMAT,
                        end_minute,
                        end_hour,
                        start_minute,
                        start_hour_byte,
                    ...
                    encoded_bytes[offset : offset + 4] = bytearray(
                        [0x00, 0x00, 0x00, 0x00]
                    )
    ...
    def decode_schedule(value: bytearray) -> dict:
        ...
        for day_index in range(7):
            ...
            for slot_index in range(3):
                ...
                # Unpack the 4 bytes
                end_minute, end_hour, start_minute, start_hour_byte = struct.unpack(
                    ScheduleCoder._SLOT_FORMAT, slot_data
                )
